...
class CleanEventListener {
    ...
    async getInitialState() {
        try {
            ...
            try {
                ...
                console.log("Could not query existing events:", error.message);
            }
    ...
    startMonitoring() {
        ...
        console.log("Press 'q' to quit, 's' for stats, 'c' for current state, 'h' for help");
...
// Main execution
async function main() {
    const listener = new CleanEventListener();
    ...
    try {
        ...
        console.log("CLEAN EVENT LISTENER IS ACTIVE!");
...
module.exports = CleanEventListener;

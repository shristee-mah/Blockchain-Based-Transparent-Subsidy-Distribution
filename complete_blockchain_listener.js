...
class CompleteBlockchainListener {
    constructor() {
        this.provider = null;
        this.contract = null;
        this.eventCount = 0;
    ...
    async start() {
        try {
            console.log("🚀 Starting Complete Blockchain Listener...");
    ...
    async queryEvents(fromBlock, toBlock) {
        try {
            console.log(`🔍 Checking blocks ${fromBlock} to ${toBlock} for events...`);
...
// Start the listener
const listener = new CompleteBlockchainListener();
